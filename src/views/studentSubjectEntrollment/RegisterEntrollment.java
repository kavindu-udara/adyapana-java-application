 ...
 * @author kavindu
 */
public class RegisterEntrollment extends javax.swing.JDialog {

    private Runnable successAction;
    
    /**
     * Creates new form RegisterEntrollment
     */
    public RegisterEntrollment(java.awt.Frame parent, boolean modal, Runnable successAction) {
        super(parent, modal);
        initComponents();
